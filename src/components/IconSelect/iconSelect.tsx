    ...
    case "mongo":
      return (
        <svg
          ...
          fill={color}
        >
          <path d="M12 2C6.48 2 2 6.48 2 12c0 5.52 4.48 10 10 10 5.52 0 10-4.48 10-10 0-5.52-4.48-10-10-10zm-1.5 15.5c-.5.5-1.5.5-2 0l-1.5-1.5c-.5-.5-.5-1.5 0-2l8-8c.5-.5 1.5-.5 2 0l1.5 1.5c.5.5.5 1.5 0 2l-8 8z"></path>
        </svg>
      );
    case "express":
      return (
    ...
    case "angular":
      return (
        ...
        >
          ...
          <path d="M12 3.074 3.689 6.038l1.268 10.987 7.043 3.9 7.043-3.9 1.268-10.987L12 3.074zm5.187 13.621H15.25l-1.045-2.606h-4.41L8.75 16.695H6.813L12 5.047l5.187 11.648z"></path>
        </svg>
      );
    case "firebase":
      return (
